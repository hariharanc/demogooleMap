...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
        ...
        LocationListener,OnMarkerDragListener,OnMapLongClickListener,OnMapClickListener {
    ...
    public void onMarkerDragEnd(Marker arg0) {
        ...
        latlng = dragLat + ","+dragLong ;
        mCurrLocationMarker.setTitle(latlng);
        Log.i("info", "drag latlng :" + latlng);
